...
function sendGamificationData(data) {
    data.name = "Felix";

    console.log(data);
    $.post("http://localhost:8000/api/push/test_app/?app=snake&name=Felix", data);
}